...
const uint32_t TableStruct_user_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::example::LoginResponse, code_),
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::example::RegisterResponse, errcode_),
  PROTOBUF_FIELD_OFFSET(::example::RegisterResponse, errmsg_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::example::LoginRequest)},
  { 8, -1, -1, sizeof(::example::RegisterRequest)},
  { 17, -1, -1, sizeof(::example::ResultCode)},
  { 25, -1, -1, sizeof(::example::LoginResponse)},
...
const char descriptor_table_protodef_user_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\004name\030\001 \001(\014\022\013\n\003pwd\030\002 \001(\014\"8\n\017RegisterRequ"
  "est\022\n\n\002id\030\001 \001(\r\022\014\n\004name\030\002 \001(\014\022\013\n\003pwd\030\003 \001"
  "(\014\"-\n\nResultCode\022\017\n\007errCode\030\001 \001(\005\022\016\n\006err"
  "Msg\030\002 \001(\014\"C\n\rLoginResponse\022!\n\004code\030\001 \001(\013"
  "2\023.example.ResultCode\022\017\n\007success\030\002 \001(\010\"3"
  "\n\020RegisterResponse\022\017\n\007errCode\030\001 \001(\005\022\016\n\006e"
  "rrMsg\030\002 \001(\0142\206\001\n\013UserService\0226\n\005Login\022\025.e"
  "xample.LoginRequest\032\026.example.LoginRespo"
  "nse\022\?\n\010Register\022\030.example.RegisterReques"
  "t\032\031.example.RegisterResponseB\003\200\001\001b\006proto"
  "3"
  ;
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_user_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_user_2eproto = {
  false, false, 441, descriptor_table_protodef_user_2eproto, "user.proto", 
...
class LoginResponse::_Internal {
 public:
  static const ::example::ResultCode& code(const LoginResponse* msg);
};
...
LoginResponse::LoginResponse(const LoginResponse& from)
  ...
  if (from._internal_has_code()) {
    code_ = new ::example::ResultCode(*from.code_);
  } else {
    code_ = nullptr;
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:example.LoginResponse)
  ...
  if (from._internal_has_code()) {
    _internal_mutable_code()->::example::ResultCode::MergeFrom(from._internal_code());
  }
