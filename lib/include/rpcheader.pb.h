...
PROTOBUF_NAMESPACE_OPEN
template<> ::myrpc::RequestHeader* Arena::CreateMaybeMessage<::myrpc::RequestHeader>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace myrpc {
...
class RequestHeader final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:myrpc.RequestHeader) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:myrpc.RequestHeader)
 private:
  class _Internal;
...
inline const std::string& RequestHeader::service_name() const {
  // @@protoc_insertion_point(field_get:myrpc.RequestHeader.service_name)
...
void RequestHeader::set_service_name(ArgT0&& arg0, ArgT... args) {
 ...
 service_name_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:myrpc.RequestHeader.service_name)
}
inline std::string* RequestHeader::mutable_service_name() {
  std::string* _s = _internal_mutable_service_name();
  // @@protoc_insertion_point(field_mutable:myrpc.RequestHeader.service_name)
  return _s;
}
...
inline std::string* RequestHeader::release_service_name() {
  // @@protoc_insertion_point(field_release:myrpc.RequestHeader.service_name)
...
inline void RequestHeader::set_allocated_service_name(std::string* service_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:myrpc.RequestHeader.service_name)
}
...
inline const std::string& RequestHeader::method_name() const {
  // @@protoc_insertion_point(field_get:myrpc.RequestHeader.method_name)
...
void RequestHeader::set_method_name(ArgT0&& arg0, ArgT... args) {
 ...
 method_name_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:myrpc.RequestHeader.method_name)
}
inline std::string* RequestHeader::mutable_method_name() {
  std::string* _s = _internal_mutable_method_name();
  // @@protoc_insertion_point(field_mutable:myrpc.RequestHeader.method_name)
  return _s;
}
...
inline std::string* RequestHeader::release_method_name() {
  // @@protoc_insertion_point(field_release:myrpc.RequestHeader.method_name)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:myrpc.RequestHeader.method_name)
}
...
inline uint32_t RequestHeader::args_size() const {
  // @@protoc_insertion_point(field_get:myrpc.RequestHeader.args_size)
...
inline void RequestHeader::set_args_size(uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:myrpc.RequestHeader.args_size)
}
