...
const uint32_t TableStruct_rpcheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::myrpc::RequestHeader, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::myrpc::RequestHeader, service_name_),
  PROTOBUF_FIELD_OFFSET(::myrpc::RequestHeader, method_name_),
  PROTOBUF_FIELD_OFFSET(::myrpc::RequestHeader, args_size_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::myrpc::RequestHeader)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::myrpc::_RequestHeader_default_instance_),
};

const char descriptor_table_protodef_rpcheader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\017rpcheader.proto\022\005myrpc\"M\n\rRequestHeade"
...
RequestHeader::RequestHeader(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:myrpc.RequestHeader)
}
RequestHeader::RequestHeader(const RequestHeader& from)
  ...
  // @@protoc_insertion_point(copy_constructor:myrpc.RequestHeader)
}
...
RequestHeader::~RequestHeader() {
  // @@protoc_insertion_point(destructor:myrpc.RequestHeader)
...
// @@protoc_insertion_point(message_clear_start:myrpc.RequestHeader)
...
uint8_t* RequestHeader::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:myrpc.RequestHeader)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:myrpc.RequestHeader)
  return target;
}

size_t RequestHeader::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:myrpc.RequestHeader)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:myrpc.RequestHeader)
...
// @@protoc_insertion_point(class_specific_copy_from_start:myrpc.RequestHeader)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::myrpc::RequestHeader* Arena::CreateMaybeMessage< ::myrpc::RequestHeader >(Arena* arena) {
  return Arena::CreateMessageInternal< ::myrpc::RequestHeader >(arena);
}
